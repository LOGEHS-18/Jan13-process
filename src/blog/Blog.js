    ...
    <I18nextProvider i18n={i18n}>
      <ThemeProvider theme={defaultTheme}>
        ...
        <Container
          maxWidth="100%"
          sx={{
            backgroundImage: 'linear-gradient(to right,#F5F7FA ,#b0c4de,#F5F7FA)',
            padding: 0,
            margin: 0,
          }}
          className="BlogPage"
            ...
            <Grid item xs={12} md={6}>
              <Slider {...sliderSettings}>
                ...
                <div>
                  <div style={{ position: 'relative', paddingTop: '30%', paddingRight: '10%', textAlign: 'center', color: 'white' }}>
                    <img
                      src="https://police.rajasthan.gov.in/new/assets/SliderImages/s6.jpg"
                      alt="Slider 4"
                      style={{
                        position: 'absolute',
                        top: 0,
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6} sx={{ boxShadow: "unset" }}>
                {featuredPosts.map((post) => (
                  <Card key={post.title}>
                    <CardActionArea component="a" href="/FeedBack" onClick={() => handleNavigate(post)} sx={{ color: 'whitesmoke', textDecorationColor: 'white' }}>
                      <Grid container>
